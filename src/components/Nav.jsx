...
function Nav() {
  ...
  return (
    <div
      id="nav"
      className={` bg-[#151414]  fixed top-0 w-full h-[13%] p-4 flex justify-between transition-transform duration-300 z-50 ${
